...
//            currentSection.content += "${EOL}include::"+name+"[]${EOL}"
    ...
    def isItalic(qName) {
        ["citetitle","emphasis",'firstterm'].contains(qName)
    }
    ...
    def isCode(qName) {
        ["classname","screen","command","type","constant","varname","function","interfacename",'filename','literal','methodname','code','exceptionname','package','property','parameter'].contains(qName)
    }
